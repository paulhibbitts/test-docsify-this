...
<div class="docsifythisurlbuilderoptionsline"><label type="color">Set the page link color to:</label><br>#<input value="0374B5" id="linkcolor" oninput="updatecolorpreview()"/><span class="colorpreview" id="linkcolorpreview"><i></i></span></div>
