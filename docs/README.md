...
<div class="docsifythisurlbuilderoptionsline"><label type="color">Page link color:</label><br><input type="text" size="7" value="#0374B5" id="linkcolor" oninput="validateColorAndUpdatePreview()" data-coloris><span id="linkcolorpreview"></span></div>
