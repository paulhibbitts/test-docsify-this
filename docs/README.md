...
https://preview-v2.docsify-this.net/?basePath=https://raw.githubusercontent.com/paulhibbitts/docsify-this-one-page-article/main&homepage=home.md&docsify-theme=true&max-width=910px. This parameter can be particularly valuable when using the default `docsify-theme` and embedding the resulting page.
...
https://preview-v2.docsify-this.net/?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&docsify-theme=true&theme-color=CC0000. This parameter can be particularly valuable when using the default `docsify-theme` and wanting to retain the default link style.  
...
https://preview-v2.docsify-this.net/?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&docsify-theme=true&theme-color=CC0000&dark-mode=auto&theme-color-dark-mode=FF9E9E.  This parameter can be particularly valuable when using the default `docsify-theme` and wanting to retain the default link style.  
