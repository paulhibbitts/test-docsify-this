...
To render a set of Markdown files (located in the same GitHub repository) with the initial page being the README.md file as a standalone Website, the URL for the would be: https://paulhibbitts.github.io/test-docsify-this/?basePath=https://raw.githubusercontent.com/nicolas-van/easy-markdown-to-github-pages/master

To render a set of Markdown files (located in the same GitHub repository) with the initial page being the README.md file as a standalone Website with each page having it's own table of contents, the URL for the site would be: https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/nicolas-van/easy-markdown-to-github-pages/master&toc=true

To render a set of Markdown files (located in the same GitHub repository) with the initial page being the README.md file as a standalone Website with each page having it's own table of contents and an "Edit this Page" link, the URL for the site would be: https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/nicolas-van/easy-markdown-to-github-pages/master&toc=true&editThisPageLink=https://github.com/nicolas-van/easy-markdown-to-github-pages/blob/master/README.md

To render a set of Markdown files (located in the same GitHub repository) as a standalone Website with each page having it's own Docsify Sidebar, the URL would be for the site's homepage: https://docsify-this.net/?basePath=https://raw.githubusercontent.com/nicolas-van/easy-markdown-to-github-pages/master&sidebar=true
