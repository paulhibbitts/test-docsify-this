...
<div class="docsifythisurlbuilderoptionsline"><label>Page title on Browser tab:</label><br><input type="text" value="Published by Docsify-This" id="pageTitle" name="pageTitle"></div>
