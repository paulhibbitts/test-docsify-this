...
<input name="markdownFileURL" aria-label="markdown file url" id="docsifythisurlfield" type="url" autofocus="autofocus" onfocus="initSelectURLFieldText()" onclick="selectURLFieldText()" onkeypress="checkKey(event);" size="200px" value="https://github.com/hibbitts-design/docsify-open-publishing-starter-kit/blob/main/README.md" />
