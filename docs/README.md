...
<input class="docsifythisurlbuildercheckbox" type="checkbox" id="editCheck" unchecked><label style="position: relative;top: 2px;" for="editCheck">Include 'Edit this Page' Link (requires GitHub URL)</label></br>
