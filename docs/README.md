...
<textarea
    ...
    placeholder="Paste Markdown file URL • Choose display options below, or add URL parameters directly here">https://github.com/paulhibbitts/docsify-this-one-page-article/blob/main/home.md</textarea>
<style>
#docsifythisurlfield {
