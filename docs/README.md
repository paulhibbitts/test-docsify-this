...
This site, built using the magical documentation site generator [Docsify](https://docsify.js.org) and based on the [Docsify Open Publishing Starter Kit](https://github.com/hibbitts-design/docsify-open-publishing-starter-kit), provides a quick way to publish Markdown files as standalone Web pages using Docsify without needing to setup your own Docsify instance - all you need is a publicly available Markdown file and pass that URL to https://docsify.this. Try it out below!  
