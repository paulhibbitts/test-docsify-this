...
<div style="background: #e8f5e8; border: 1px solid #a8c4aa; border-radius: 8px; padding: 12px; margin: 20px 0; display: flex; align-items: center; gap: 12px;">
    <div style="flex: 1;">
        ...
        <div style="color: #666; margin-top: 2px; font-size: 16px;">Built with the latest Docsify v5.0 release candidate and featuring a refreshed UI.</div>
    </div>
...
https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-publishing-starter-kit/main/docs&homepage=introduction.md&dark-mode=on
