...
Please note that the standard [Docsify configuration setting](https://docsify.js.org/#/configuration) of **[maxLevel](https://docsify.js.org/#/configuration?id=maxlevel)** can also be used as a URL parameter to set the maximum header level of the Docsify sidebar, for example https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-publishing-starter-kit/main/docs&homepage=introduction.md&sidebar=true&maxLevel=2 
