...
<div class="docsifythisurlbuilderoptionsline"><div class='stackedlabeldropdown' style='margin-bottom:4px;border-radius: 7px;border-color: #8e8f9d'>
  <label for="enableDarkmode">Dark Theme:</label>
...
- [coverpage-color-dark-theme](/?id=coverpage-color-dark-theme)
- [dark-theme](/?id=dark-theme)
- [edit-link-emoji](/?id=edit-link-emoji)
- [link-color-dark-theme](/?id=link-color-dark-theme)
- [link-color-hover](/?id=link-color-hover)
- [link-color-hover-dark-theme](/?id=link-color-hover-dark-theme)
...
##### coverpage-color-dark-theme

Set a custom color for the coverpage in dark mode with the optional **coverpage-color-dark-theme** parameter, for example:  
https://paulhibbitts.github.io/test-docsify-this/?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-publishing-starter-kit/main/docs&homepage=home.md&dark-theme=auto&link-color=CC0000&link-color-dark-theme=FF9E9E&coverpage=_coverpage.md&coverpage-color=cc0000&coverpage-color-dark-theme=4d0000

##### dark-theme

Enable dark theme or automatically switch light/dark theme based on system OS-level preference with the optional **dark-theme** parameter, for example:  
https://preview-v2.docsify-this.net/?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-publishing-starter-kit/main/docs&homepage=introduction.md&dark-theme=on
...
Set a custom color for all links in dark mode, defined using the standard hexadecimal format _without the '#' symbol_ with the optional **link-color-dark-theme** parameter, for example:  
https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&link-color=CC0000&dark-theme=auto&link-color-dark-theme=FF9E9E.
...
https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&link-hover-color=CC0000.

##### link-color-hover-dark-theme

Set a custom hover color for all links in dark mode, defined using the standard hexadecimal format _without the '#' symbol_ with the optional **link-hover-color-dark-theme** parameter, for example:  
https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&link-color=CC0000&dark-theme=auto&link-hover-color-dark-theme=FF9E9E.
...
- [Website with Docsify Navbar](https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-this-multiple-page-site/main&homepage=home.md&loadNavbar=_navbar "Docsify-This Multiple Page Site - Web Pages with Docsify Navbar and an 'Edit this Page' link")
...
- [Website with automatic light/dark theme switching](https://paulhibbitts.github.io/test-docsify-this/?basePath=https://raw.githubusercontent.com/paulhibbitts/docsify-this-simple-visual-portfolio/main&homepage=README.md&font-size=1.25&browser-tab-title=Design%20Portfolio&loadFavicon=favicon.png&dark-theme=auto "Docsify-This Simple Visual Portfolio")
...
- [Website with automatic light/dark theme switching](https://paulhibbitts.github.io/test-docsify-this/?basePath=https://raw.githubusercontent.com/paulhibbitts/docsify-this-visual-portfolio/main&homepage=README.md&sidebar=true&loadSidebar=_sidebar.md&loadFavicon=favicon.png&name=Design%20Portfolio&dark-theme=auto "Docsify-This Visual Portfolio")
...
- [Website with automatic light/dark theme switching](https://paulhibbitts.github.io/test-docsify-this/?basePath=https://raw.githubusercontent.com/paulhibbitts/docsify-this-markdown-student-portfolio-starter/main&homepage=README.md&dark-theme=auto "Docsify-This Markdown Starter Portfolio Template")
