...
<div class="docsifythisurlbuilderoptionsline"><label>Page title on Browser tab:</label><br><input type="text" value="Published by Docsify-This" id="pageTitle" name="pageTitle" size="25"></div>
...
<div class="docsifythisurlbuilderoptionsline"><label>Text of 'Edit this Page' link:</label><br><input type="text" value="Edit this Page" id="editLinkText" name="editLinkText" size="25"></div>
