...
**link-color**  
Set a custom color for all links, defined using the standard hexadeciaml format _without the '#' symbol, for example, for example https://paulhibbitts.github.io/test-docsify-this?basePath=https://raw.githubusercontent.com/hibbitts-design/docsify-open-course-starter-kit/main/docs&homepage=resources.md&link-color=CC0000.
