...
<div class="docsifythisurlbuilderoptionsline">Logo folder path and filename for Website displayed in Sidebar:<br><input style="border-radius: 7px;border-color: #8e8f9d" aria-label="Website logo displayed in Sidebar" type="text" maxlength="80" value="" id="siteLogo" name="siteLogo"></div>
