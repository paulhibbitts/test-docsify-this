...
<div class="docsifythisurlbuilderoptionsline"><input class="docsifythisurlbuildercheckbox" type="checkbox" id="usegithubdotdev" unchecked><label for="zoomimages">Use the GitHub.dev web-based editor (Beta) for files hosted on GitHub.com</label></div>
