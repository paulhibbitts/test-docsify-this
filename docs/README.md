...
Enter the URL of a Markdown file and view that file as a standalone web page in a new Browser tab. This URL may then be copied and shared. The URL Builder will also automatically transform a URL of a GitHub Markdown file into the needed raw source URL (i.e. raw.githubusercontent.com).
