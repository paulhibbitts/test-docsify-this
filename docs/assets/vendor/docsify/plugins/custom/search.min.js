 ...
 *    page sections (/#/?id=SECTION) both map to "home"; no per-group cap (ze())
 ...
 *    hyphens→spaces; role="heading" aria-level="3" (ze())
 ...
 *    case-insensitive); hidden when heading matches page name (ze())
 ...
 *    visible (title ≠ page name) over a suppressed one; empty groups removed (ze())
