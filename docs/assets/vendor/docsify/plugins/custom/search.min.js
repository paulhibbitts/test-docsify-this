 ...
 * 2. Page grouping — results grouped by page, capped at 3 per page (ze() function)
 * 3. Page/group headers — page name label above each group with role="heading"
 *    aria-level="3"; color uses var(--color-mono-5,#666) for WCAG AA contrast (ze())
