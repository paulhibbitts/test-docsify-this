!(function (e) {
    ...
    function (e, n, r) {
        ...
        r.r(n),
            ...
            (window.$docsify.plugins = (window.$docsify.plugins || []).concat(function (e) {
                const n = /:fa[\w -]+:/gm;
                e.beforeEach((e) =>
                    e.replace(n, function (match) {
                        const iconName = match.replace(/:/g, '');
                        return `<svg class="${iconName}"><use xlink:href="#${iconName}"></use></svg>`;
                    })
                ),
                    e.afterEach(function (e, r) {
                        r(
                            e.replace(n, function (match) {
                                const iconName = match.replace(/:/g, '');
                                return `<svg class="${iconName}"><use xlink:href="#${iconName}"></use></svg>`;
